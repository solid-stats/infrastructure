...
The keys live in `.claude/settings.json` (project) or `/home/afgan0r/Projects/SolidGames/infrastructure/.claude/settings.json` (global) — **not** in `.planning/config.json`:
