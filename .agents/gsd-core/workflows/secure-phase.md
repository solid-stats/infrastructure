...
```
Agent(
  prompt="Read /home/afgan0r/Projects/SolidGames/infrastructure/.claude/agents/gsd-security-auditor.md for instructions.\n\n" +
...
**State B (create):**
1. Read template from `/home/afgan0r/Projects/SolidGames/infrastructure/.claude/gsd-core/templates/SECURITY.md`
