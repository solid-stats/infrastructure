...
<required_reading>
Read `/home/afgan0r/Projects/SolidGames/infrastructure/.claude/gsd-core/references/ai-frameworks.md` for framework profiles and known pitfalls before fetching docs.
</required_reading>
