...
<objective>
Manage the runtime skill surface without reinstall. Reads/writes `/home/afgan0r/Projects/SolidGames/infrastructure/.claude/.gsd-surface.json`
(sibling to `/home/afgan0r/Projects/SolidGames/infrastructure/.claude/.gsd-profile`) and re-stages the active skills directory in place.
Skill dirs live at `/home/afgan0r/Projects/SolidGames/infrastructure/.claude/skills/gsd-*/`.
...
(`/home/afgan0r/Projects/SolidGames/infrastructure/.claude`), NOT the skills sub-directory (`/home/afgan0r/Projects/SolidGames/infrastructure/.claude/skills`).

This matches `installRuntimeArtifacts` and `uninstallRuntimeArtifacts`, which also
receive `/home/afgan0r/Projects/SolidGames/infrastructure/.claude` as `configDir`. The skill dirs themselves live at
`/home/afgan0r/Projects/SolidGames/infrastructure/.claude/skills/gsd-*/` because the `claude global` layout has `destSubpath =
'skills'` — they are derived from `configDir`, not the root for it.

```bash
# Claude Code — global install
RUNTIME_CONFIG_DIR="${CLAUDE_CONFIG_DIR:-/home/afgan0r/Projects/SolidGames/infrastructure/.claude}"
SCOPE="global"
...
(i.e. `/home/afgan0r/Projects/SolidGames/infrastructure/.claude/.gsd-surface.json`).
...
<execution_context>
Surface state file: `/home/afgan0r/Projects/SolidGames/infrastructure/.claude/.gsd-surface.json`
Install profile marker: `/home/afgan0r/Projects/SolidGames/infrastructure/.claude/.gsd-profile`
Skill dirs: `/home/afgan0r/Projects/SolidGames/infrastructure/.claude/skills/gsd-*/`
Engine module: `/home/afgan0r/Projects/SolidGames/infrastructure/.claude/gsd-core/bin/lib/surface.cjs`
Cluster definitions: `/home/afgan0r/Projects/SolidGames/infrastructure/.claude/gsd-core/bin/lib/clusters.cjs`
</execution_context>
