...
def main() -> int:
    ...
    if args.schema == "recovery" and args.state_root and args.run_id:
        ...
        public = parse_exact_result(root / "public-boundary.result", "solidstats-memory-public-boundary-evidence/v1", {"sequence", "qdrant_6333_blocked", "qdrant_6334_blocked", "authenticated_mcp_boundary", "authenticated_mcp_probe_sha256", "api_policy_sha256"})
        ...
        iso_03 = public["qdrant_6333_blocked"] == public["qdrant_6334_blocked"] == public["authenticated_mcp_boundary"] == "true" and public["api_policy_sha256"] == api["policy_sha256"] and public["authenticated_mcp_probe_sha256"] == hashlib.sha256(safe(root / "probe-forward.json", 0o600)).hexdigest() and live.get("public_qdrant_blocked") is True and all(value is True for key, value in probes["forward"]["auth_checks"].items() if key != "session_contract")
